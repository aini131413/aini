...
@section("content")
    <div class="container" style="margin-top: 30px">
        ...
        <form action="" class="form-group" method="post">
            ...
            {{--确认密码--}}
            <div class="form-group has-feedback">
                <label for="passwordConfirm">原密码</label>
                <div class="input-group">
                    <span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
                    <input name="old_password" class="form-control" placeholder="请输入原密码,不修改密码不用输入" maxlength="20" type="password">
                </div>
            ...
            <div class="form-group has-feedback">
                ...
                <div class="input-group">
                    <span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
                    <input name="password" class="form-control" placeholder="请输入新密码，不修改密码不用输入" maxlength="20" type="password" >
                </div>
            </div>
